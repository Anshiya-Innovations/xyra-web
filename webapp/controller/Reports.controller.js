    ...
    return Controller.extend("xyraweb.controller.Reports", {
      ...
      _loadFilterOptions: function () {
        ...
        fetch(Config.AUTH_BASE_URL + "/api/control/listControls", {
          ...
          .then(function (oData) {
            if (!oData.success) {
              throw new Error(oData.message || "listControls failed");
            }
            oModel.setProperty(
              "/controls",
              (oData.controls || []).map(function (c) {
                return { key: c.id, text: c.code + " - " + c.description };
              }),
            );
          })
          .catch(function () {
            /* leave empty - Control select just won't offer options */
          });
        ...
        fetch(Config.AUTH_BASE_URL + "/api/system-config/listSystems", {
          ...
          .then(function (oData) {
            if (!oData.success) {
              throw new Error(oData.message || "listSystems failed");
            }
            ...
            oModel.setProperty(
              "/systems",
              [{ key: "All", text: "All Systems" }].concat(
                distinct(function (s) {
                  return s.sysId;
                }),
              ),
            ...
            oModel.setProperty(
              "/clients",
              [{ key: "All", text: "All Clients" }].concat(
                distinct(function (s) {
                  return s.client;
                }),
              ),
            ...
            oModel.setProperty(
              "/regions",
              [{ key: "All", text: "All Regions" }].concat(
                distinct(function (s) {
                  return s.region;
                }),
              ),
            ...
            oModel.setProperty(
              "/platforms",
              [{ key: "All", text: "All Platforms" }].concat(
                distinct(function (s) {
                  return s.platform;
                }),
              ),
            ...
            oModel.setProperty(
              "/sectors",
              [{ key: "All", text: "All Sectors" }].concat(
                distinct(function (s) {
                  return s.sector;
                }),
              ),
          ...
          .catch(function () {
            /* leave the "All" fallbacks already in the model */
          });
      },
      ...
      onGenerateHistory: function () {
        ...
        fetch(Config.AUTH_BASE_URL + "/api/control/listControlHistory", {
          ...
          .then(function (oData) {
            if (!oData.success) {
              MessageBox.error(
                oData.message || "Could not load control history.",
              );
            ...
            var iDeviations = aRows.filter(function (r) {
              return r.deviationFlag;
            }).length;
            oModel.setProperty("/rows", aRows);
            oModel.setProperty("/summary", {
              total: aRows.length,
              passed: aRows.length - iDeviations,
              deviations: iDeviations,
            });
      ...
      onExportCsv: function () {
        ...
        if (aRows.length === 0) {
          MessageBox.information(
            "No control history records available to export.",
          );
          return;
        }
      ...
      onReviewer1: function () {
        this.getOwnerComponent().getRouter().navTo("Reviewer1");
      },
      onReviewer2: function () {
        this.getOwnerComponent().getRouter().navTo("Reviewer2");
      },
      onEscalationManager: function () {
        this.getOwnerComponent().getRouter().navTo("EscalationManager");
      },
